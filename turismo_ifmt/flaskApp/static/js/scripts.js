...
/*
        ...
        '<div class="cont" id="cx">',
            '<div class="cmsg">',
                ...
                '<div class="cxresp">',
                    ...
                    '{{resposta}}',
                    '<div class="cidade">Cidade: {{cidade}} - Proximidade: {{ratio}}%</div> </div>',
                '</div>',
            '</div>',
        '</div>'
    ].join("\n");
    ...
    for (x in top3) {
        ...
        //var html = Mustache.render(template, top3);
        $("#cxresp").append(html);
    //}
    */
    var html = '<div class="cont" id="cx">'+
            '<div class="cmsg">'+
                '<div class="tit">Pergunta similar:</div>'+
                '<div class="resp">'+ top3.pergunta +'</div>'+
                '<div class="cxresp">'+
                    '<div class="tit">Resposta Similar:</div>'+
                        top3.resposta+
                    '<div class="pag">Cidade:'+top3.cidade+'</div>'+
                '</div>'+
            '</div>'+
        '</div>';
